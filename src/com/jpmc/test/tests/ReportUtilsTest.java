...
public class ReportUtilsTest {
    ...
    private Trade trade1 = new Trade("bar", TransactionType.B, new BigDecimal(0.5), "USD", LocalDate.of(2018, 5, 11),
            LocalDate.of(2018, 5, 14), 200, new BigDecimal(100.25));

    private Trade trade2 = new Trade("bar1", TransactionType.B, new BigDecimal(0.6), "USD", LocalDate.of(2018, 5, 11),
            LocalDate.of(2018, 5, 14), 300, new BigDecimal(110.25));

    private Trade trade3 = new Trade("foo", TransactionType.S, new BigDecimal(0.5), "USD", LocalDate.of(2018, 5, 11),
            LocalDate.of(2018, 5, 14), 200, new BigDecimal(100.25));

    private Trade trade4 = new Trade("foo1", TransactionType.S, new BigDecimal(0.6), "USD", LocalDate.of(2018, 5, 11),
            LocalDate.of(2018, 5, 14), 300, new BigDecimal(110.25));

    private Trade trade5 = new Trade("bar2", TransactionType.B, new BigDecimal(0.5), "USD", LocalDate.of(2018, 5, 11),
            LocalDate.of(2018, 5, 15), 200, new BigDecimal(100.25));

    private Trade trade6 = new Trade("foo2", TransactionType.S, new BigDecimal(0.5), "USD", LocalDate.of(2018, 5, 11),
            LocalDate.of(2018, 5, 15), 200, new BigDecimal(100.25));
